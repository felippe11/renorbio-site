        ...
        GaleriaService.getFotos(slug)
          .then(galeriasDados => {
            ...
            for (let i = 0; i < galeriasDados.acf.fotos.length; i++) {
              const fotoTratada = {
                thumb: (galeriasDados.acf.fotos[i].acf.anexo) ? galeriasDados.acf.fotos[i].acf.anexo : galeriasDados.acf.fotos[i].acf.link,
                src: (galeriasDados.acf.fotos[i].acf.anexo) ? galeriasDados.acf.fotos[i].acf.anexo : galeriasDados.acf.fotos[i].acf.link,
